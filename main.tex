...
\begin{itemize}
  \item \textbf{GeoGS: Geospatial Gaussian Splatting for Robust 3D Reconstruction from Sparse Satellite Imagery}. Han-Gyeol Kim$^*$, \textbf{Seonghyeon Yun}$^*$, JaeWan Park, Darongsae Kwon. \emph{CVPR 2026 EarthVision Workshop}. ($^*$ equal contribution)
\end{itemize}
