...
\begin{itemize}
  ...
  \item \textbf{Parallel ARC-AGI Solver via Transductive LLMs and Rule-Based CPU Search} \\
        Team project, SNU Basics of Deep Learning (Spring 2025). Solving an easier subset of the ARC-AGI benchmark. Transductive Llama-3.1-8B (LoRA + Test-Time Training) running concurrently with rule-based hard-coded solutions.
