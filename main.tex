...
\begin{itemize}
  \item Han-Gyeol Kim$^*$, \textbf{Seonghyeon Yun}$^*$, JaeWan Park, Darongsae Kwon. ``GeoGS: Geospatial Gaussian Splatting for Robust 3D Reconstruction from Sparse Satellite Imagery.'' \emph{CVPR 2026 EarthVision Workshop}.
\end{itemize}
