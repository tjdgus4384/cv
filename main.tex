...
\begin{itemize}
  \item \entry{Agency for Defense Development (ADD)}{Jun.~2028 -- Jun.~2031 (expected)}{Research Officer for National Defense}{Republic of Korea}
  \begin{itemize}
    \item Three-year defense R\&D commission at ADD through the ROND program -- Korea's elite STEM officer track modeled after Israel's Talpiot -- fulfilling mandatory military service.
  \end{itemize}
...
\begin{itemize}
  \item \textbf{National Science and Engineering Scholarship} \hfill \textit{2025 -- Present} \\
        ...
        \begin{itemize}
          \item Elected as a 12th-cohort cadet of Research Officers for National Defense (ROND); $\sim$25 selected nationwide per year.
