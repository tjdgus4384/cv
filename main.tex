...
\usepackage{xcolor}
\usepackage[colorlinks=false, pdfborder={0 0 1}, urlbordercolor={0.4 0.75 1.0}, linkbordercolor={0.4 0.75 1.0}]{hyperref}
\usepackage{titlesec}
\usepackage{enumitem}
...
\begin{itemize}
  ...
  \item \textbf{GeoGS: Geospatial Gaussian Splatting for Robust 3D Reconstruction from Sparse Satellite \mbox{Imagery}}. Han-Gyeol Kim$^*$, \textbf{Seonghyeon Yun}$^*$, JaeWan Park, Darongsae Kwon. \emph{CVPR 2026 EarthVision Workshop}. ($^*$ equal contribution) \href{https://github.com/tjdgus4384/GeoGS}{[code]}
\end{itemize}
